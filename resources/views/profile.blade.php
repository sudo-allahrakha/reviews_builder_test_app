                     ...
                     <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body p-lg-5">
                           ...
                           <div class="d-flex align-items-center">
                              <img src="./assets/placeholder/user.jpg" alt="avatar" width="50" class="avatar avatar-lg rounded-circle">
                              <div class="ms-4">
                        ...
                        <div class="card-body p-lg-5">
                           ...
                           <form class="row g-3 needs-validation" novalidate="">
                              <div class="col-lg-6 col-md-12">
                                 ...
                                 <input type="text" class="form-control" id="profileFirstNameInput" value="{{ Auth::user()->first_name}}" required="">
                                 <div class="invalid-feedback">Please enter firstname.</div>
                              </div>
                              <div class="col-lg-6 col-md-12">
                                 <label for="profileLastNameInput" class="form-label">Last Name</label>
                                 <input type="text" class="form-control" id="profileLastNameInput" value="{{ Auth::user()->last_name}}" required="">
